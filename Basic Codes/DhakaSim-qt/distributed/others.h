...
{
    filename1 = "/home/dhakasim/Desktop/without qt/Path.txt";
    filename2 = "/home/dhakasim/Desktop/without qt/Demand.txt";
    //filename1 = "dhakasim@192.168.44.28:/home/dhakasim/Desktop/DhakaSIM/qt/Path.txt";
    //filename2 = "dhakasim@192.168.44.28:/home/dhakasim/Desktop/DhakaSIM/qt/Demand.txt";
    readPath();
    readDemand();
    addPath();
}
...
inline void VehicleLoad::readPath()
{
    try{
        ...
        for(index = 0; index<numPaths; index++)
        {
            ...
            fscanf(fp,"%[^\r]",str); //for linux use /r for windows use /n
            char *pp;
            pp = strtok(str," ");
            vector<string> V;
            while(pp!=NULL)
...
class NetworkParse
{
    ...
    int numberOfSegments;   // newly added
public:
    string fileName;
    NetworkParse();
    void readNetwork();
...
{
    numberOfSegments = 0;
    fileName = "/home/dhakasim/Desktop/without qt/Network.txt";
    //fileName = "dhakasim@192.168.44.28:/home/dhakasim/Desktop/DhakaSIM/qt/Network.txt";
    readNetwork();
}
...
inline void Genetic::setNetwork(vector<Link> linkList){
...
inline void Genetic::doPartition(){
    int i,j,x,size,k;
    srand(time(NULL));
    ...
    for(i=0;i<NODE;i++)
        output.push_back(old_generation[elite].computer[i]);

}
inline void Genetic::GenerateGeneration(){
